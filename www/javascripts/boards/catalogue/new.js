$(document).ready(function() {
	...
	$('#slboard_catalogue_new_form').submit(function(){
		var result=true;
		...
		//$('#slboard_catalogue_new_form').submit();

		$.post($('#slboard_catalogue_new_form').attr('action'),json,function(data){
			if(data.result=='success') {
				$('#slboard_catalogue_new_form').slideUp(function(){
