	...
	<div class="scrollable">
		<div class="items">
			...
			<ul class="item">
				...
				<li><a href="/galleries/<?php echo $gallery_value['id'] ?>" title="<?php echo $gallery_value['title'] ?>"><img width="100" height="100" src="<?php echo htmlspecialchars(phpThumbURL('src=/../uploads/gallery/'.$gallery_value['id'].'/'.$gallery_value['photo'].'&w=100&h=100', '/phpThumb/phpThumb.php')) ?>" alt="<?php echo $gallery_value['id'] ?>" /></a></li>
				<?php endforeach ?>
			</ul>
			<?php endforeach ?>
		</div>
